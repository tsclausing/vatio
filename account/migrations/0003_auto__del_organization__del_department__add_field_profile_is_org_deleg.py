...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.is_org_delegate'
        db.add_column(u'accounts_profile', 'is_org_delegate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.is_dept_admin'
        db.add_column(u'accounts_profile', 'is_dept_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Profile.org'
        db.alter_column(u'accounts_profile', 'org_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['organization.Organization'], unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'accounts_department', (
            ('org', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Organization'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        ...
        # Deleting field 'Profile.is_org_delegate'
        db.delete_column(u'accounts_profile', 'is_org_delegate')

        # Deleting field 'Profile.is_dept_admin'
        db.delete_column(u'accounts_profile', 'is_dept_admin')


        # Changing field 'Profile.org'
        db.alter_column(u'accounts_profile', 'org_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Organization'], unique=True, null=True))

    models = {
        u'accounts.profile': {
            'Meta': {'object_name': 'Profile'},
            'dept': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'profile+'", 'null': 'True', 'to': u"orm['organization.Organization']"}),
