...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_profile', (
            ...
            ('org', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Organization'], unique=True, null=True)),
        ...
        m2m_table_name = db.shorten_name(u'accounts_profile_dept')
        ...
        db.create_unique(m2m_table_name, ['profile_id', 'organization_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_profile_dept'))
